...
def parse_questions(file_path):
    '''
    Parsuje pytania i odpowiedzi z pliku tekstowego i zwraca je w formacie JSON.

    :param file_path: Path to the input file containing questions and answers.
    '''
